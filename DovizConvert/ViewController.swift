...
class ViewController: UIViewController, GADFullScreenContentDelegate {
    ...
    @IBAction func getRatesButton(_ sender: Any) {
        ...
        let audButton = UIAlertAction(title: "AUD", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "AUD")
        }
        
        let cadButton = UIAlertAction(title: "CAD", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "CAD")
        }
        
        let chfButton = UIAlertAction(title: "CHF", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "CHF")
        }
        
        let hkdButton = UIAlertAction(title: "HKD", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "HKD")
        }
        
        let sekButton = UIAlertAction(title: "SEK", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "SEK")
        }
        
        let nokButton = UIAlertAction(title: "NOK", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "NOK")
        }
        
        let inrButton = UIAlertAction(title: "INR", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "INR")
        }
        
        let mxnButton = UIAlertAction(title: "MXN", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "MXN")
        }
        
        let brlbutton = UIAlertAction(title: "BRL", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "BRL")
        }
        
        let dkkButton = UIAlertAction(title: "DKK", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "DKK")
        }
        
        let plnButton = UIAlertAction(title: "PLN", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "PLN")
        }
        
        let thbButton = UIAlertAction(title: "THB", style: .default) { UIAlertAction in
            self.performSegue(withIdentifier: "go2", sender: "THB")
        }
        ...
        alerts.addAction(audButton)
        alerts.addAction(cadButton)
        alerts.addAction(chfButton)
        alerts.addAction(hkdButton)
        alerts.addAction(sekButton)
        alerts.addAction(nokButton)
        alerts.addAction(mxnButton)
        alerts.addAction(brlbutton)
        alerts.addAction(dkkButton)
        alerts.addAction(plnButton)
        alerts.addAction(inrButton)
        alerts.addAction(thbButton)
